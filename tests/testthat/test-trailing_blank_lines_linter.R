...
test_that("blank lines in knitr chunks produce lints", {
  ...
  expect_lint(
    file = tmp6,
    checks = list(message = rex::rex("Remove trailing blank lines."), line_number = 7L, column_number = 1L),
    linters = linter
  )
  ...
  expect_lint(
    file = tmp7,
    checks = list(
      list(message = rex::rex("Remove trailing blank lines."), line_number = 7L, column_number = 1L),
      list(message = rex::rex("Remove trailing blank lines."), line_number = 8L, column_number = 1L),
      list(message = rex::rex("Remove trailing blank lines."), line_number = 9L, column_number = 1L)
    ),
    linters = linter
  )
})
