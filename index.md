...
[lintr](https://lintr.r-lib.org) provides [static code analysis for
...
semantic issues, then reports them to you so you can take action.
...
Running [`lintr::lint()`](https://lintr.r-lib.org/reference/lint.md) on
this file would produce the following output:
...
[lintr](https://lintr.r-lib.org) is complementary to [the `{styler}`
package](https://github.com/r-lib/styler) which automatically restyles
code, eliminating some of the problems that
[lintr](https://lintr.r-lib.org) can detect.
...
[usethis](https://usethis.r-lib.org) provides helper functions to
...
or text editor. See
[`vignette("continuous-integration")`](https://lintr.r-lib.org/articles/continuous-integration.md)
and [`vignette("editors")`](https://lintr.r-lib.org/articles/editors.md)
for more details.

Without further configuration, this will run the [default
linters](https://lintr.r-lib.org/reference/default_linters.html). See
[`vignette("lintr")`](https://lintr.r-lib.org/articles/lintr.md) to
learn how to modify these defaults.
