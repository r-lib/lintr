...
- Lint a directory using
  ...
  This will apply [`lint()`](https://lintr.r-lib.org/reference/lint.md)
  to all R source files matching the `pattern` argument. By default,
  this means all `.R` files as well as `knitr` formats (e.g. `.Rmd`,
  `.Rnw`).
...
- Lint all relevant directories of an R package using
  ...
  This will apply
  [`lint_dir()`](https://lintr.r-lib.org/reference/lint.md) to all
...
[`use_lintr()`](https://lintr.r-lib.org/reference/use_lintr.md) in the
project directory. Lintr supports per-project configuration of the
following fields.
...
2.  A project-local linter file; that is, either
    1.  a linter file (that is, a file named like `lintr.linter_file`)
        ...
        file passed to
        [`lint()`](https://lintr.r-lib.org/reference/lint.md); or
...
3.  A project-local linter file in the closest parent directory of the
    ...
    [`lint_package()`](https://lintr.r-lib.org/reference/lint.md), this
    directory can differ for each linted file.
...
|  | default |
|:---|:---|
| linters | [`lintr::default_linters`](https://lintr.r-lib.org/reference/default_linters.md) |
| encoding | UTF-8 |
...
| exclusions | (empty) |
| cache_directory | /home/hgruson/.cache/R/lintr |
| error_on_lint | FALSE |
...
[`lint()`](https://lintr.r-lib.org/reference/lint.md) is invoked.
