...
* `line_length_linter()` gains argument `allow_alignment_calls` (defaulting to `c("tribble", "rowwiseDT")`) to ignore line length inside tabular alignment calls (#3133, @randy3k).
