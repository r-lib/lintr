...
* `commas_linter()` gains argument `allow_alignment_calls` (defaulting to `c("tribble", "fcase", "rowwiseDT")`) to allow leading spaces before commas for tabular alignment (#3053, @randy3k).
