...
* switched CI from Travis to GitHub Actions, using the full tidyverse recommended R CMD check. Code coverage uses a separate GitHub Actions workflow (#572, @dragosmg)
