...
- [`Lint()`](https://lintr.r-lib.org/dev/reference/lint-s3.md), and thus
  all linters, ensures that the returned object’s `message` attribute is
...
- [`indentation_linter()`](https://lintr.r-lib.org/dev/reference/indentation_linter.md)
  handles `for` un-braced for loops correctly
...
- `get_source_expression()` captures warnings emitted by the R parser
  ...
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) returns them
  as lints ([\#2065](https://github.com/r-lib/lintr/issues/2065),
  [@MichaelChirico](https://github.com/MichaelChirico)).
...
- [`expect_lint()`](https://lintr.r-lib.org/dev/reference/expect_lint.md)
  ...
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) produces
  them ([@MichaelChirico](https://github.com/MichaelChirico)).
...
- [`use_lintr()`](https://lintr.r-lib.org/dev/reference/use_lintr.md)
  adds the created `.lintr` file to the `.Rbuildignore` if run in a
  package ([\#2926](https://github.com/r-lib/lintr/issues/2926), initial
  work by [@MEO265](https://github.com/MEO265), finalized by
  [@Bisaloo](https://github.com/Bisaloo)).
...
- [`download_file_linter()`](https://lintr.r-lib.org/dev/reference/download_file_linter.md)
  ...
  [@Bisaloo](https://github.com/Bisaloo)).
- `lint2df_linter()` encourages the use of the
...
- [`unnecessary_nesting_linter()`](https://lintr.r-lib.org/dev/reference/unnecessary_nesting_linter.md):
  ...
  - Treats `=` assignment the same as `<-` when deciding to combine
    ...
    [@MichaelChirico](https://github.com/MichaelChirico)).
- [`unnecessary_nesting_linter()`](https://lintr.r-lib.org/dev/reference/unnecessary_nesting_linter.md)
  treats function bodies under the shorthand lambda (`\()`) the same as
...
- [`T_and_F_symbol_linter()`](https://lintr.r-lib.org/dev/reference/T_and_F_symbol_linter.md)
  ignores `T` and `F` used as symbols in formulas (`y ~ T + F`), which
  can represent variables in data not controlled by the author
  ([\#2637](https://github.com/r-lib/lintr/issues/2637),
  [@MichaelChirico](https://github.com/MichaelChirico)).
- [`T_and_F_symbol_linter()`](https://lintr.r-lib.org/dev/reference/T_and_F_symbol_linter.md)
  ignores `T` and `F` if followed by `[` or `[[`
...
- More consistency on handling `@` extractions
...
- [`scalar_in_linter()`](https://lintr.r-lib.org/dev/reference/scalar_in_linter.md)
  ...
  ([@F-Noelle](https://github.com/F-Noelle))
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) and friends
  now normalize paths to forward slashes on Windows
...
- [`Linter()`](https://lintr.r-lib.org/dev/reference/Linter.md) has a
  new argument `linter_level=` (default `NA`). This is used by
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) to more
...
- [`expect_no_lint()`](https://lintr.r-lib.org/dev/reference/expect_lint.md)
  ...
  [@F-Noelle](https://github.com/F-Noelle)).
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) and friends
  emit a message if no lints are found
...
- Toggle lint progress indicators with argument `show_progress` to
  [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md) and
  [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md)
...
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md),
  [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md), and
  [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md) fail
...
- Quarto files (.qmd) are included by
  [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md) by
  default ([\#2150](https://github.com/r-lib/lintr/issues/2150),
...
- `.lintr` files can now be kept in the directory `.github/linters` for
  ...
  Please see
  [`vignette("lintr")`](https://lintr.r-lib.org/dev/articles/lintr.md)
  for details on how configs are discovered
...
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md),
  [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md), and
  [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md) no
...
- Improved error behavior in
  [`Lint()`](https://lintr.r-lib.org/dev/reference/lint-s3.md),
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) and
  ...
  - [`Lint()`](https://lintr.r-lib.org/dev/reference/lint-s3.md)
    validates its inputs more thoroughly, preventing errors during
    `print.Lints` like “Error in rep.int(character, length) : invalid
    ‘times’ value:”.
...
- [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md) also
...
- When a linter triggers an error,
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) will provide
  a more actionable summary of where the error occurred, particularly
  useful for cases like
  [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md)
  where both the responsible file and the responsible linter would be
  unknown ([@MichaelChirico](https://github.com/MichaelChirico)).
...
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) continues to
  ...
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) in order for
...
- The output of
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) and
  [`Lint()`](https://lintr.r-lib.org/dev/reference/lint-s3.md) gain S3
  ...
  - As a corollary, we now register an `as_tibble` method for class
    ...
    [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) output
...
- [`modify_defaults()`](https://lintr.r-lib.org/dev/reference/modify_defaults.md)
  ...
  [`Linter()`](https://lintr.r-lib.org/dev/reference/Linter.md) also
...
- [`redundant_ifelse_linter()`](https://lintr.r-lib.org/dev/reference/redundant_ifelse_linter.md)’s
...
- New
  [`sort_linter()`](https://lintr.r-lib.org/dev/reference/sort_linter.md)
  to detect `x[order(x)]` and recommend the faster and clearer
  alternative: `sort(x)`
  ([\#1528](https://github.com/r-lib/lintr/issues/1528),
  [@Bisaloo](https://github.com/Bisaloo))
...
- Prevent [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) from
...
- Fixed file exclusion detection in
  [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md) so it no
...
- The `...` argument for
  [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md),
  [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md), and
  [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md) has
  been promoted to an earlier position to better match the [Tidyverse
  design
  ...
  [@MichaelChirico](https://github.com/MichaelChirico)).
  - For [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md), `...`
    is now the 3rd argument, where earlier this was `cache`.
  - For [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md)
    and
    [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md),
...
- [`trailing_blank_lines_linter()`](https://lintr.r-lib.org/dev/reference/trailing_blank_lines_linter.md):
  - Extended to lint files without a terminal newline
    ...
    [@AshesITR](https://github.com/AshesITR)).
  - Also, running
    [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) on a file
    without a terminal newline no longer throws a
    [`warning()`](https://rdrr.io/r/base/warning.html).
- [`trailing_whitespace_linter()`](https://lintr.r-lib.org/dev/reference/trailing_whitespace_linter.md):
...
- [`cyclocomp_linter()`](https://lintr.r-lib.org/dev/reference/cyclocomp_linter.md):
  ...
  [@AshesITR](https://github.com/AshesITR)).
- [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md) now
...
- **Documentation**: Reorganize linter documentation into new tag-based
  ...
  - [`?linters`](https://lintr.r-lib.org/dev/reference/linters.md) also
...
- [`is_lint_level()`](https://lintr.r-lib.org/dev/reference/is_lint_level.md):
  ...
  [@MichaelChirico](https://github.com/MichaelChirico)).
- [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md) excludes
  the `renv` and `packrat` directories by default
  ([\#697](https://github.com/r-lib/lintr/issues/697),
  [@AshesITR](https://github.com/AshesITR)).
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md): new
  optional argument `text` for supplying a line or lines directly,
  e.g. if the file is already in memory or linting is being done *ad
  hoc* ([\#503](https://github.com/r-lib/lintr/issues/503),
  [@renkun-ken](https://github.com/renkun-ken)).
- [`seq_linter()`](https://lintr.r-lib.org/dev/reference/seq_linter.md):
...
- [`unneeded_concatenation_linter()`](https://lintr.r-lib.org/dev/reference/lintr-deprecated.md):
  ...
  - New argument `allow_single_expression`, default `TRUE`, toggling
    ...
    [@MichaelChirico](https://github.com/MichaelChirico)).
- [`use_lintr()`](https://lintr.r-lib.org/dev/reference/use_lintr.md):
  new exported helper for creating a minimal `.lintr` configuration
...
- [`lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md) will
  now lint vignettes and data-raw by default
  ([\#447](https://github.com/r-lib/lintr/issues/447),
  [@AshesITR](https://github.com/AshesITR)).
- [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md) will now
...
- New [`lint_dir()`](https://lintr.r-lib.org/dev/reference/lint.md)
  function to lint files under a given directory
...
- [`Lint()`](https://lintr.r-lib.org/dev/reference/lint-s3.md) /
  ...
  [@fangly](https://github.com/fangly)).
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) no longer
  errors with inline `\\Sexpr`
  ([\#127](https://github.com/r-lib/lintr/issues/127)).
- [`lint()`](https://lintr.r-lib.org/dev/reference/lint.md) no longer
  errors with ‘\<% %\>’ constructs
