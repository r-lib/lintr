...
Running [`lintr::lint()`](https://lintr.r-lib.org/dev/reference/lint.md)
on this file would produce the following output:
...
or text editor. See
[`vignette("continuous-integration")`](https://lintr.r-lib.org/dev/articles/continuous-integration.md)
and
[`vignette("editors")`](https://lintr.r-lib.org/dev/articles/editors.md)
for more details.
