...
[`lintr::lint_package()`](https://lintr.r-lib.org/dev/reference/lint.md)
on your package.
...
[`lintr::lint()`](https://lintr.r-lib.org/dev/reference/lint.md) on the
R and R Markdown files included in a given project.
