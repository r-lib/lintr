...
writeLines("a=1", f)
lint(f)
#> /tmp/Rtmpldemji/file19f0a297805:1:2: style: [assignment_linter] Use one of <-, <<- for assignment, not =.
#> a=1
#>  ^
#> /tmp/Rtmpldemji/file19f0a297805:1:2: style: [infix_spaces_linter] Put spaces around all infix operators.
#> a=1
#>  ^
unlink(f)
