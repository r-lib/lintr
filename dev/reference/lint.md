...
writeLines("a=1", f)
lint(f)
#> /tmp/RtmpaPms44/file199b2792e325:1:2: style: [assignment_linter] Use <- for assignment, not =.
#> a=1
#>  ^
#> /tmp/RtmpaPms44/file199b2792e325:1:2: style: [infix_spaces_linter] Put spaces around all infix operators.
#> a=1
#>  ^
unlink(f)
