...
#'   "   2. Named elements are numeric or a list. The name gives a path relative to the config.",
#'   "      `Inf` can always be used to indicate 'all lines'.",
#'   "      1. Numeric or unnamed list elements are line numbers to be excluded in the given path or directory.",
#'   "      2. Named list elements, where the name specifies a linter, are line numbers to be excluded for that linter.",
