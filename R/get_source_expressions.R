...
fixup_line <- function(line) {
  # helper to ensure a valid string is provided as line where necessary handles tow cases:
  #  * NA lines, as generated by running outside of code blocks in Rmd documents
  #  * invalid string lines, as generated by invalid encoding settings
  if (is.na(line)) {
    return("")
  }
  tryCatch({
    nchar(line, type = "chars")
    line
  }, error = function(e) "")
}
