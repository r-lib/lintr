...
get_assignment_symbols <- function(xml) {
  left_assignment_symbols <-
    xml2::xml_text(xml2::xml_find_all(xml, "expr[LEFT_ASSIGN]/expr[1]/*[1]/descendant-or-self::SYMBOL[1]"))
  equal_assignment_symbols <-
    xml2::xml_text(xml2::xml_find_all(xml, "equal_assign/expr[1]/*[1]/descendant-or-self::SYMBOL[1]"))
  assign_fun_symbols <-
