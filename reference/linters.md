...
Within a [`lint()`](https://lintr.r-lib.org/reference/lint.md) function
call, the linters in use are initialized with the provided arguments and
fed with the source file (provided by
...
- [default](https://lintr.r-lib.org/reference/default_linters.md) (26
  linters)

- [efficiency](https://lintr.r-lib.org/reference/efficiency_linters.md)
  (30 linters)

- [executing](https://lintr.r-lib.org/reference/executing_linters.md) (6
  linters)
...
- [regex](https://lintr.r-lib.org/reference/regex_linters.md) (4
  linters)

- [robustness](https://lintr.r-lib.org/reference/robustness_linters.md)
  (19 linters)

- [style](https://lintr.r-lib.org/reference/style_linters.md) (40
  linters)

- [tidy_design](https://lintr.r-lib.org/reference/tidy_design_linters.md)
  (1 linters)
...
- [`seq_linter`](https://lintr.r-lib.org/reference/seq_linter.md) (tags:
