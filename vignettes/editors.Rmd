...
![RStudio Example](man/figures/rstudio.png "Rstudio Example")
...
![Emacs Example](`r maybe_still("man/figures/emacs.gif")` "Emacs Example")
...
![Vim Example](`r maybe_still("man/figures/vim-syntastic.gif")` "Vim Example")
...
![Sublime Example](`r maybe_still("man/figures/sublime.gif")` "Sublime Example")
...
![Atom Example](man/figures/atom.png "Atom Example")
...
![VS Code Example](man/figures/vscode.png "VS Code Example")
