...
It's recommended to use Alt+Shift+L for linting the current source code and Ctrl+Shift+Alt+L to code the package.
...
#### Configuration \#### You can configure what linters are used.
e.g. using a different line length cutoff.
