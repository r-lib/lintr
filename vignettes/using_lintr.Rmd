...
**file3.R**
```r
X = 42L # nolint: object_name. this comment overflows the default 80 chars line length.
```

`> lint("file3.R")`
```{r, echo = FALSE}
lintr::lint("X = 42L # nolint: object_name. this comment overflows the default 80 chars line length.\n",
            parse_settings = FALSE)
```
...
**file4.R**
```r
X = 42L # nolint: object_name, line_length. this comment overflows the default 80 chars line length.
```
...
lintr::lint(
  paste(
    "X = 42L",
    "# nolint: object_name, line_length. this comment overflows the default 80 chars line length.\n"
  ),
  parse_settings = FALSE
)
```
