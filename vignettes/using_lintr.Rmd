...
The settings file is searched for in the following order. The first one found, if any, will be used.
 ...
 2. A linter file (that is a file named like `lintr.linter_file`) in the currently searched directory,
    i.e. the directory of the file passed to `lint()`. When ran from `lint_package()`, this directory can vary by each
    linted file.
 ...
 4. A linter file in the users `HOME` directory.
